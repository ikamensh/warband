...
Download the [0.2.0-preview.1 Windows installer](https://github.com/ikamensh/warband/releases/download/v0.2.0-preview.1/Warband-0.2.0-preview.1-windows-x64-setup.exe)
...
The [0.2.0-preview.1 release](https://github.com/ikamensh/warband/releases/tag/v0.2.0-preview.1)
...
```powershell
uv run --extra package python tools/package.py build --version 0.2.0-preview.1 --installer --require-clean
