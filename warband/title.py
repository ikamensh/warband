...
class TitleScene(Scene):
    ...
    def _build_menu(self) -> None:
        ...
        self._masthead = Label("", height=150)  # the title and its tagline are drawn in this space above the first button
        menu.add(self._masthead)
    ...
    def draw(self) -> None:
        ...
        _x, top, _w, _h = self._masthead.bounds
        cy = top + 46
