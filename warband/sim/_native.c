/* warband.sim._native: the loops of the simulation that mypyc cannot keep out of Python objects, in C,
...
static struct PyModuleDef module = {PyModuleDef_HEAD_INIT, "warband.sim._native", NULL, -1, methods};
