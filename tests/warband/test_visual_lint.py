...
SCREENS = ("title", "new_game_elf", "new_game_master", "select_peasant", "pending_salvage", "select_town_hall", "select_army", "select_60_units", "town_at_work", "menu_build_hover", "menu_train_hover",
