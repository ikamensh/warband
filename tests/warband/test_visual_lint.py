...
SCREENS = ("title", "new_game_elf", "new_game_master", "select_peasant", "select_town_hall", "select_army", "select_60_units", "town_at_work", "menu_build_hover", "plans", "alerts", "battle_wood",
